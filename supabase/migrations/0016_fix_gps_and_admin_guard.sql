-- GPS hanya dapat ditulis melalui RPC ini; DEFINER diperlukan karena tabel
-- cod_locations sengaja tidak memiliki policy INSERT langsung.
...
-- Status sensitif boleh diubah oleh admin JWT atau service role backend setelah
-- endpoint requireAdmin sukses. User biasa tetap ditolak trigger.
