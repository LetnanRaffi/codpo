...
const res = await fetch(env.NEXT_PUBLIC_SUPABASE_URL + "/rest/v1/conversations", {
  method: "POST",
  headers: {
  ...
  body: JSON.stringify({ listing_id: l.id, buyer_id: ld.data.user.id, seller_id: l.seller_id }),
});
